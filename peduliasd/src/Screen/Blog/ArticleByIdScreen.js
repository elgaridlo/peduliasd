                    ...
                    <div className="modal-content text-center">
                        <div className="modal-body">
                            ...
                            <div className="newsletter-wrapper">
                                <div className="row">
                                    <button className="btn btn-info rounded-pill mb-2" 
                                        data-bs-dismiss="modal"
                                        aria-label="Close"
                                        onClick={() => deleteHandler()}>Ya
                                    </button> {' '}
                                    <button 
                                        className="btn btn-danger rounded-pill" data-bs-dismiss="modal"
                                        aria-label="Close">Tidak
                                    </button> 
                                </div>
                            </div>
                        </div>
